...
const assets = { '/': ['web-recreate.html', 'text/html'], '/web-recreate-browser.mjs': ['web-recreate-browser.mjs', 'text/javascript'], '/web-recreate.mjs': ['web-recreate.mjs', 'text/javascript'] };
