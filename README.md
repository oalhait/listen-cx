...
`/threads` lists the Threads owned or subscribed to by the signed-in account plus
this browser's anonymous history, with relationship, creation dates, song counts, and closed state. New creations
