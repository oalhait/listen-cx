/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 511bb6912d29fccec2e35916b0ddbc0f)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BASE_URL: "" | "https://staging.listen.cx" | "https://listen.cx";
	JAMS_ENABLED: false;
	MUSIC_ACCOUNT_CONNECTIONS_ENABLED: "false" | "true";
	ACCOUNT_SUBSCRIPTIONS_ENABLED: "false" | "true";
	SPOTIFY_PUBLISHING_ENABLED: "false" | "true";
	APPLE_PUBLISHING_ENABLED: "false" | "true";
	SPOTIFY_REDIRECT_URI: "" | "https://staging.listen.cx/auth/callback" | "https://listen.cx/account/spotify/callback";
	THREAD_PUBLISHER: DurableObjectNamespace<import("./src/worker-production").ThreadPublisher>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-production");
		durableNamespaces: "ThreadLive" | "ThreadPublisher";
	}
	interface DevEnv {
		DB: D1Database;
		BASE_URL: "";
	...
	interface StagingEnv {
		...
		ACCOUNT_SUBSCRIPTIONS_ENABLED: "true";
		SPOTIFY_PUBLISHING_ENABLED: "true";
		APPLE_PUBLISHING_ENABLED: "true";
		SPOTIFY_REDIRECT_URI: "https://staging.listen.cx/auth/callback";
		THREAD_PUBLISHER: DurableObjectNamespace<import("./src/worker-production").ThreadPublisher>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "JAMS_ENABLED" | "MUSIC_ACCOUNT_CONNECTIONS_ENABLED" | "ACCOUNT_SUBSCRIPTIONS_ENABLED" | "SPOTIFY_PUBLISHING_ENABLED" | "APPLE_PUBLISHING_ENABLED" | "SPOTIFY_REDIRECT_URI">> {}
}
