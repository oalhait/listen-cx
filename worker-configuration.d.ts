/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f28f1d2ee0fae01bd2bffb35c4bebdf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "THREAD_MAX_THREADS">> {}
}
