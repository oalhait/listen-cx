/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2885d19c2094e63aefac446736d1aea)
...
interface __BaseEnv_Env {
	...
	THREAD_PUBLISHER: DurableObjectNamespace<import("./src/worker").ThreadPublisher>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ThreadPublisher";
	}
	interface DevEnv {
		DB: D1Database;
		BASE_URL: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "JAMS_ENABLED" | "SPOTIFY_PUBLISHING_ENABLED" | "APPLE_PUBLISHING_ENABLED" | "MUSIC_ACCOUNT_CONNECTIONS_ENABLED" | "ACCOUNT_SUBSCRIPTIONS_ENABLED" | "SPOTIFY_REDIRECT_URI">> {}
}
