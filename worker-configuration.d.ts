/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c314a0ae700dd312ef0a05ce9401757)
...
interface __BaseEnv_Env {
	...
	APPLE_MUSIC_ENABLED: false | true;
	...
	THREAD_LIVE: DurableObjectNamespace<import("./src/worker").ThreadLive>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ThreadLive";
	}
	interface DevEnv {
		DB: D1Database;
		THREAD_CREATE_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "THREADS_ENABLED" | "THREAD_MAX_THREADS" | "APPLE_MUSIC_ENABLED" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT">> {}
}
